        ...
        <div class="main-left">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                ...
                <p class="mb-6 text-gray-500">
                    ...
                    pour envoyer un email de confirmation:<a href= "mailto: sofiane.jellouli@uit.ac.ma ?subject=activé un account  &body=bonjour,Je me suis inscrit maintenant et je souhaite activer le compte ."> Click here</a>
                </p>
